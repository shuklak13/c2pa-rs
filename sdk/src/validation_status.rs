...
/// Hash of a ISO BMFF based asset matches the hash declared in the BMFF
/// hash assertion.
///
/// `ValidationStatus.url()` will point to a C2PA assertion.
pub const ASSERTION_BMFFHASH_MATCH: &str = "assertion.bmffHash.match";

/// Hash of a names assets boxes matches the hash declared in the box 
/// hash assertion.
///
/// `ValidationStatus.url()` will point to a C2PA assertion.
...
/// The hash of an ISO BMFF based asset does not match the hash declared
/// in the BMFF hash assertion.
///
/// `ValidationStatus.url()` will point to a C2PA assertion.
pub const ASSERTION_BMFFHASH_MISMATCH: &str = "assertion.bmffHash.mismatch";

/// The hash of named asset boxes does not match the
/// hash declared in the box hash assertion.
///
/// `ValidationStatus.url()` will point to a C2PA assertion.
